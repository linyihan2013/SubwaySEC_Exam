...
public interface SubwayManager
{
    ...
    Integer getShortestDistance(String enterStation, String exitStation);
    
    Integer calculatePriceForStations(String enterStation, String exitStation) throws SubwayException;
    /**
     * Query subways.
     *
     * @return the list
